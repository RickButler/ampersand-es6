/*$AMPERSAND_VERSION*/
import runOnce from 'lodash/once';
import keys from 'lodash/keys';
import isEmpty from 'lodash/isEmpty';
import assign from 'lodash/assign';
import forEach from 'lodash/forEach';
import utils from 'ampersand-events/libs/utils';
...
export default class Events {
    constructor() {
        ...
        this.listenTo = utils.createListenMethod('on');
        this.listenToOnce = utils.createListenMethod('once');
    }
    ...
    listenToAndRun(obj, name, callback) {
