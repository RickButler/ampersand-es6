...
const queryNoElMsg = 'Query cannot be performed as this.el is not defined. Ensure that the view has been rendered.';


let BaseState = State.extend({
    dataTypes: {
        element: {
            set: function (newVal) {
                return {
...
class View extends BaseState {
    ...
    // argument.
    renderWithTemplate(context, templateArg) {
